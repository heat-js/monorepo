...
describe('abs', () => {
	const t = (expected:any, value:any) => {
		it(`${expected} === abs(${value})`, () => {
			const result = new Big(value).abs().toString()
			expect(result)
	...
	t('0.00000000009622', '-0.00000000009622');
	t('0.000000000509', '-0.000000000509');
	t('3838.2', '3838.2');
	t('127', '127.0');
	t('4.23073', '4.23073');
	t('2.5469', '-2.5469');
	t('29949', '-29949');
	t('277.1', '-277.10');
	t('0.00000000000000497898', '-0.00000000000000497898');
	t('53.456', '53.456');
	t('100564', '-100564');
	t('12431.9', '-12431.9');
	t('97633.7', '-97633.7');
	...
	t('35', '-35');
	t('2.6', '-2.6');
	t('0.00000000000000000022', '-0.000000000000000000220');
	t('1.469', '-1.469');
	t('150.7', '-150.7');
	t('74', '-74');
	t('0.00000000352', '-0.00000000352');
	t('2221.7', '-2221.7');
	t('0.000004211', '-0.000004211');
	t('1', '-1');
	t('5.886', '-5.886');
	t('16', '16');
	t('0.0000000044493', '0.0000000044493');
	t('47.6', '47.6');
	t('1.6', '-1.60');
	t('1', '-1');
	t('1.5', '-1.5');
	...
	t('1', '-1');
	t('8027', '8027');
	t('0.000000000000000636', '-0.000000000000000636');
	t('3.87766', '3.87766');
	t('7.4', '-7.4');
	t('4.449', '-4.449');
	t('0.00000000000000000052', '-0.000000000000000000522180');
	t('0.000000000013769', '-0.000000000013769');
	t('0.0000000000007898', '-0.0000000000007898');
	t('522.9', '-522.9');
	t('16.1', '-16.1');
	t('2.15', '2.15');
	t('4.3', '4.3');
	...
	t('1.4544', '1.4544');
	t('53.691', '53.691');
	t('0.00000000000203832', '-0.00000000000203832');
	t('1', '-1');
	t('10.8', '10.8');
	t('6189.2', '-6189.2');
	t('6.30866', '6.30866');
